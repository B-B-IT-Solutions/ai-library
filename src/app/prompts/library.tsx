...
import {DPrompt} from "@/src/data/domain/prompt";
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 p-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          <h1 className="text-4xl font-bold mb-2 text-slate-900">Prompt Manager</h1>
          <p className="text-slate-600">Create, version, and organize your AI prompts</p>
        </header>
            ...
            <div className="bg-white rounded-lg border border-slate-200 shadow-sm max-h-[600px] overflow-y-auto">
              ...
              <div className="divide-y divide-slate-200">
                {filteredPrompts.map((prompt) => (
                  ...
                  >
                    <h3 className="font-medium mb-1 text-slate-900">{prompt.title}</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mb-2">
                      Add suggested follow-up questions or prompts that users might want
                      to ask next.
                    </p>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          copyToClipboard(
                            selectedPrompt.versions[selectedPrompt.versions.length - 1]
                              .content,
                            "current-prompt"
                          );
                        }}
