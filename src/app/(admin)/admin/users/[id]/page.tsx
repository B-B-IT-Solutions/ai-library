...
const AdminUserDetailPage = async (props: Props) => {
   ...
   return (
      <div className="container mx-auto max-w-7xl px-4 py-8" data-testid="admin-user-detail-page">
         <div className="mb-8">
            <h1 className="mb-2 text-3xl font-bold text-slate-900">{user.name}</h1>
