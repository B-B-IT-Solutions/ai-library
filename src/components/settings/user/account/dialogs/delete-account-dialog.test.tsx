...
import { DeleteAcountDialog } from "./delete-account-dialog";
...
describe("DeleteAcount functionality tests", () => {
   ...
   it("delete account - success true - test", async () => {
   ...
   it("delete account - success false - test", async () => {
      const result: ActionResult = {
         success: false,
   ...
   it("delete account - cancel - test", async () => {
      const result: ActionResult = {
         success: false,
         message: "Account couldn't be deleted",
      };
