...
export const SURVEY_SEGMENTS: DSurveySegments = {
...
export const SOLOPRENUER_QUESTIONS: DSurveyQuestion[] = [
   {
      id: "freq",
...
export const EMPLOYEE_QUESTIONS: DSurveyQuestion[] = [
   {
      id: "freq",
...
export const COACH_QUESTIONS: DSurveyQuestion[] = [
   {
      id: "freq",
...
export const DEFAULT_QUESTIONS: DSurveyQuestion[] = [
   {
      id: "freq",
...
export const SURVEY_DATA: DSurveyData = {
   solo: SOLOPRENUER_QUESTIONS,
   employee: EMPLOYEE_QUESTIONS,
   coach: COACH_QUESTIONS,
