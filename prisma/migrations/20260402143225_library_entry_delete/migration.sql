...
-- CreateIndex
CREATE INDEX "library_collection_entry_prompt_template_descriptor_id_idx" ON "library_collection_entry"("prompt_template_descriptor_id");

-- CreateIndex
CREATE UNIQUE INDEX "library_collection_entry_collection_id_prompt_template_desc_key" ON "library_collection_entry"("collection_id", "prompt_template_descriptor_id");

-- AddForeignKey
ALTER TABLE "library_collection_entry" ADD CONSTRAINT "library_collection_entry_prompt_template_descriptor_id_fkey" FOREIGN KEY ("prompt_template_descriptor_id") REFERENCES "prompt_template_descriptor"("id") ON DELETE CASCADE ON UPDATE CASCADE;
