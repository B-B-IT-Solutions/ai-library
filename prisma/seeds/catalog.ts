   ...
   },
   {
      ...
      fields: [
         ...
         },
         {
            ...
            description:
               "Warum verlässt die Person das Unternehmen? (optional)",
            type: "TEXT" as const,
            required: false,
            order: 1,
         },
   ...
   },
   {
      ...
      fields: [
         ...
         },
         {
            ...
            description:
               "Welche Schritte sind nötig? (grobe Stichpunkte reichen)",
            type: "TEXTAREA" as const,
            required: true,
            order: 1,
         },
      ...
      fields: [
         {
            ...
            description:
               "Füge die Rohkommentare ein (z.B. aus Umfragen oder Reviews)",
            type: "TEXTAREA" as const,
            required: true,
            order: 0,
         },
   ...
   },
   {
      ...
      fields: [
         ...
         },
         {
            ...
            description:
               "Was verbindet euch? (z.B. Post, gemeinsame Kontakte, Ereignis)",
            type: "TEXT" as const,
            required: true,
            order: 1,
         },
      ...
      fields: [
         {
            ...
            description:
               "Was ist über den Lead bekannt? (Notizen, Gesprächsverlauf)",
            type: "TEXTAREA" as const,
            required: true,
            order: 0,
         },
   ...
   },
   {
      ...
      fields: [
         ...
         },
         {
            ...
            description:
               "Welcher Moment aus dem Gespräch soll aufgegriffen werden?",
            type: "TEXTAREA" as const,
            required: true,
            order: 2,
         },
...
export const initCatalogData = async (prisma: PrismaClient) => {
   console.log("\Deleting existing catalog categories...");
