...
description: Prompt-Workflows Feature — Branching, step-by-step prompt chains. BASIC+PRO only. Runner is copy-paste mode. Steps are TEMPLATE_REF or STANDALONE. Private only (MVP).
metadata:
  type: project
---
...
- Steps: TEMPLATE_REF (aus Bibliothek) oder STANDALONE (Text direkt im Workflow)
